...
add wave -noupdate -expand -group Constants -radix unsigned /BillyCPU_testbench/dut/instrDec/imm16
...
WaveRestoreCursors {{Cursor 1} {1294779 ps} 0}
...
update
WaveRestoreZoom {776938 ps} {1463540 ps}
