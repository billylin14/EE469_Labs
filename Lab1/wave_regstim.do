...
add wave -noupdate /regstim/dut/muxTemp
add wave -noupdate -radix unsigned /regstim/WriteData
...
WaveRestoreCursors {{Cursor 1} {245739720 ps} 0}
...
update
WaveRestoreZoom {0 ps} {300989926 ps}
